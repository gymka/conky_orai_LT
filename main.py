...
class orai():
	...
	dangus_nakti=re.findall("<img alt=\".*For the period.*(23:00–05:00|02:00–08:00|00:00–06:00|21:00–03:00)\" src=\"http://symbol.yr.no/grafikk/sym/b38/(.*.png)\" width=\"38\" height=\"38",orai_html_long,re.IGNORECASE)
		
	#temperatūros naktį. orai_long.temp_nakti()[0][1])
	temp_nakti=re.findall("<td class=\"temperature .*\" title=\"Temperature:.*Feels like.*For the period: (23:00|02:00|00:00|21:00)\">(.*)°</td>",orai_html_long,re.IGNORECASE)
	...
	#grąžina masyvą su 3 elementais
	vejas_naktis=re.findall("<td class=\"txt-left\" title=\"(.*), (.*m/s) from (.*)\.  For the period: (23:00|02:00|00:00|21:00)\">",orai_html_long,re.IGNORECASE)
